            ...
            <div class="container is-fluid has-text-left">
                <div class="columns">
                    <div class="column is-9">
                        ...
                        <p class="is-size-4">了解您的網站需求、業務、功能與風格，並依您預算評估可行性與時程。評估若您我皆可接受製作方案與價格，就會與您收取50%訂金，並簽訂契約。</p>
                    ...
                    <div class="column is-3">
                        <p class="title is-1" data-scroll data-scroll-speed="4"><i class="fas fa-route"></i></p>
                    </div>
                </div>
            </div>
        </div>
